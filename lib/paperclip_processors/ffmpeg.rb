  ...
  class Ffmpeg < Processor
    ...
    def make
      ...
      when 'mp4'
        ...
        @convert_options[:output][:b] = '512k'     
        @convert_options[:output][:bt] = '56k'   
        @convert_options[:output][:ab] = '128k'   
      ...
      if @drawtext.present?
        ...
        @drawtext.each_with_index do |drawtext, index|
          ...
          drawtext_directive += ":fontsize='" + drawtext[:fontsize].to_s + "'" if drawtext[:fontsize].present?  # In px height. Default is 16.
